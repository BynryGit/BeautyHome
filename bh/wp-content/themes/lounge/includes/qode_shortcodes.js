            ...
            jQuery('#qode_shortcodes_menu_holder').load(url + '/qode_shortcodes_popup.html#qode_shortodes_popup', function(){
                ...
                jQuery("#qode_shortcodes_menu_holder").css({top: y, left: x});
								...
								jQuery("#SC_tabs").click(function(){
									var shortcode = "[tabs tab1=\"Tab 1\" tab2=\"Tab 2\" tab3=\"Tab 3\"]<br /><br />[tab id=1]<h5>Tab title 1</h5> Tab content 1[/tab]<br />[tab id=2]<h4>Tab title 2</h4> Tab content 2[/tab]<br />[tab id=3]<h4>Tab title 3</h4> Tab content 3[/tab]<br /><br />[/tabs]";
									ed.execCommand('mceInsertContent', false, shortcode);   
									jQuery("#qode_shortcodes_menu_holder").remove();                          
								})
								...
								jQuery("#SC_h2_with_line").click(function(){
									var shortcode = "[h2_with_line]Title[/h2_with_line]";
									ed.execCommand('mceInsertContent', false, shortcode);   
									jQuery("#qode_shortcodes_menu_holder").remove();                          
								})
								...
								jQuery("#SC_latest_post").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_latest_post.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var shortcode = "[latest_post post_number='"+post_number+"' category='"+category+"' text_length='"+text_length+"'/]";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_message").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_message.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var shortcode = "[message background_color='"+background_color+"'] <h4>Title</h4><p>content content content</p> [/message]";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_button").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_button.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var shortcode = "[button size='" + size + "' color='"+ color + "' background_color='"+ background_color +"' border_color='"+ border_color +"' font_size='"+ font_size +"' line_height='"+ line_height +"' font_style='"+ font_style +"' font_weight='"+ font_weight +"' text='"+ text +"' link='"+ link +"' target='"+ target +"']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);	
										   tb_remove();
										   return false;
								...
								jQuery("#SC_pricing_table").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_pricing_table.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var shortcode = "[pricing_table]<br/><br/>[pricing_column type='"+type+"' title='Price dummy title' price='100' price_value='$' price_period='mo' link='insert your link here' button_text='Buy Now' active='no' active_text='Most Popular']<br/><br/>[pricing_cell] content content content [/pricing_cell]<br/>[pricing_cell] content content content [/pricing_cell]<br/>[pricing_cell] content content content [/pricing_cell]<br/><br/>[/pricing_column]<br/><br/>[/pricing_table]";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_portfolio_list").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_portfolio_list.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var shortcode = "[portfolio_list type='" + type + "' columns='"+columns+"' order_by='"+order_by+"' order='"+order+"' number='"+number+"' category='"+category+"' selected_projects='"+selected_projects+"' filter='"+filter+"']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_portfolio_slider").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_portfolio_slider.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
											 ...
											 var category = jQuery('#TB_window #category').val();
											 var selected_projects = jQuery('#TB_window #selected_projects').val();
										   var shortcode = "[portfolio_slider type='" + type + "' number='"+number+"' category='"+category+"' selected_projects='"+selected_projects+"']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_slider").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_slider.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   var type = jQuery('#TB_window #type option:selected').val();
										   var shortcode = "[slider type='"+type+"' id='insert uniqe value of slider here']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_separator_small").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_separator_small.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
											 ...
											 var top = jQuery('#TB_window #top').val();
											 var bottom = jQuery('#TB_window #bottom').val();
										   var shortcode = "[separator_small separator_width='"+separator_width+"' thickness='"+thickness+"'  up='"+top+"' down='"+bottom+"']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_testimonial").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_testimonials.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										     var background_color = jQuery('#TB_window #background_color').val();
											 var border = jQuery('#TB_window #border option:selected').val();
										     var shortcode = "[testimonials background_color='"+background_color+"']<br /><br />[testimonial name='Content content' border='"+border+"']<br/><span>- Peter Hook</span>, SEO of example.com<br/>[/testimonial]<br /><br />[testimonial name='Content content' border='"+border+"']<br/><span>- Peter Hook</span>, SEO of example.com<br/>[/testimonial]<br /><br />[/testimonials]";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
								...
								jQuery("#SC_icon").click(function(){
									...
									jQuery.get(url + "/qode_shortcodes_icon.php", function(data){
									   ...
									   jQuery('#TB_window #qode_insert_shortcode_button').click(function(){
										   ...
										   var link = jQuery('#TB_window #link').val();
										   var target = jQuery('#TB_window #target option:selected').val();
										   var shortcode = "[icon icon_type='"+icon_type+"' icon_position='"+icon_position+"' icon_number='"+icon_number+"' link='"+link+"' target='"+target+"']";
										   jQuery("#qode_shortcode_form_wrapper").remove()
										   ed.execCommand('mceInsertContent', false, shortcode);		   										   										   tb_remove();
										   return false;
									   });							
