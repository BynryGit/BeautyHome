...
$qode_options_lounge  = get_option('qode_options_lounge');
...
class Qode_Theme_Options {
	...
	function init_qode_theme_options() {
		global $qode_options_lounge;
		if(isset($qode_options_lounge['reset_to_defaults'])){ 
			if( $qode_options_lounge['reset_to_defaults'] == 'yes' ) delete_option( "qode_options_lounge");
		}
		if (! get_option("qode_options_lounge")) {
			add_option( "qode_options_lounge",
				array( // intitialize the 'qode_options_lounge' array with the following key => value pairs:
					"reset_to_defaults" => '',
					"number_of_chars" => 45,
					"first_color" => '',
					"second_color" => '',
					...
					"logo_image" => QODE_ROOT."/img/lounge-logo.png",
					"center_logo_image" => 'no',
					"menu_resize" => 'yes',
					"logo_top" => '',
					"logo_left" => '',
					"first_level_type" => 'italic',
					"first_level_separators" => 'yes',
					"first_level_separator_type" => 'regular',
					"top_menu" => 'drop_down2',
					"dropdown_color" => '',
					"dropdown_hovercolor" => '',
					...
					"slider_title_google_fonts_type2" => '-1',
	...
	function register_qode_theme_settings() {
	    register_setting( 'qode_options_lounge_page', 'qode_options_lounge', array(&$this, 'validate_options') );
	    // register_setting( 'qode_options_lounge_page', array(&$this, 'another_of_my_options') );
	}
	//extend the admin menu
	function qode_admin_menu() {
		$this->init_qode_theme_options();
		//Add the Qode options page to the Themes' menu
		$this->pagehook = add_menu_page('Qode Theme', esc_html__('Qode', 'qode'), 'manage_options', 'qode_options_lounge_page', array(&$this, 'qode_generate_options_page'));
	...
	function qode_generate_options_page() {
		...
		global $screen_layout_columns, $qode_options_lounge;
		...
		<div id="qode-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('version %1$s', 'qode'), '1.5' ); ?></h2>

		    <form method="post" action="options.php">
<?php			settings_fields( 'qode_options_lounge_page' ); // Checks that the user can update options and also redirect the user back to the correct admin page (this form).
			$options = get_option('qode_options_lounge');
...
<?php					    do_meta_boxes($this->pagehook, 'additional', $options); ?>
						...
						<label for="reset_to_defaults">
						    <input name="qode_options_lounge[reset_to_defaults]" type="checkbox" id="reset_to_defaults" value="yes" />
...
<?php	}
	...
	global $qode_options_lounge;
		$input['number_of_chars'] = is_numeric( $input['number_of_chars'] ) ? absint($input['number_of_chars']) : $qode_options_lounge['number_of_chars'];
		return $input;
	}
					...
					<tbody>
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_lounge[first_color]" type="text" value="<?php if ($options['first_color']) { echo esc_attr($options['first_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>
								...
								<input name="qode_options_lounge[second_color]" type="text" value="<?php if ($options['second_color']) { echo esc_attr($options['second_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_lounge[background_color]" type="text" value="<?php if ($options['background_color']) { echo esc_attr($options['background_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_lounge[background_color_box]" type="text" value="<?php if (isset($options['background_color_box'])) { echo esc_attr($options['background_color_box'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_lounge[highlight_color]" type="text"  value="<?php if ($options['highlight_color']) { echo esc_attr($options['highlight_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
								...
								<td>
									...
									<input name="qode_options_lounge[selection_color]" type="text"  value="<?php if ($options['selection_color']) { echo esc_attr($options['selection_color'], 'qode'); } ?>" size="30" maxlength="500" />
						...
						<tr valign="middle">
							...
							<td>	
								...
								<input type="text" id="pattern_background_image" name="qode_options_lounge[pattern_background_image]" class="pattern_background_image" value="<?php if (isset($options['pattern_background_image'])) { echo esc_attr($options['pattern_background_image'], 'qode'); } ?>" size="70">
						...
						<tr valign="middle">
							...
							<td>	
								<div class="inline" style="width: 600px;">
								<input type="text" id="favicon_image" name="qode_options_lounge[favicon_image]" class="favicon_image" value="<?php if ($options['favicon_image']) { echo esc_attr($options['favicon_image'], 'qode'); } else { echo QODE_ROOT."/img/favicon.ico"; } ?>" size="70">
								<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_lounge[google_fonts]">
						...
						<tr valign="middle">
								...
								<td>
							<select name="qode_options_lounge[page_transitions]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[boxed]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[responsiveness]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[show_back_button]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_lounge[google_analytics_code]" type="text" value="<?php if (isset($options['google_analytics_code'])) { echo esc_attr($options['google_analytics_code'], 'qode'); } ?>" size="63" maxlength="500" />
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="internal_no_ajax_links" name="qode_options_lounge[internal_no_ajax_links]" cols="60" rows="5"><?php if (isset($options['internal_no_ajax_links'])) { echo esc_attr($options['internal_no_ajax_links'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_css" name="qode_options_lounge[custom_css]" cols="60" rows="5"><?php if ($options['custom_css']) { echo esc_attr($options['custom_css'], 'qode'); } ?></textarea>
								</div>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="custom_js" name="qode_options_lounge[custom_js]" cols="60" rows="5"><?php if ($options['custom_js']) { echo esc_attr($options['custom_js'], 'qode'); } ?></textarea>
								</div><br/>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_keywords" name="qode_options_lounge[meta_keywords]" cols="60" rows="5"><?php if ($options['meta_keywords']) { echo esc_attr($options['meta_keywords'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									<textarea id="meta_description" name="qode_options_lounge[meta_description]" cols="60" rows="5"><?php if ($options['meta_description']) { echo esc_attr($options['meta_description'], 'qode'); } ?></textarea>
								</div>
							</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<select name="qode_options_lounge[disable_qode_seo]">
						...
						<tr valign="top">
							...
							<td>
								<select name="qode_options_lounge[show_toolbar]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h1_color]" type="text" value="<?php if ($options['h1_color']) { echo esc_attr($options['h1_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h1_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										...
										<input name="qode_options_lounge[h1_fontsize]" type="text" value="<?php if ($options['h1_fontsize']) { echo esc_attr($options['h1_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h1_lineheight]" type="text" value="<?php if ($options['h1_lineheight']) { echo esc_attr($options['h1_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h1_fontstyle]">
									...
									<div class="inline">
										...
										<select name="qode_options_lounge[h1_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h2_color]" type="text" value="<?php if ($options['h2_color']) { echo esc_attr($options['h2_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h2_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[h2_fontsize]" type="text" value="<?php if ($options['h2_fontsize']) { echo esc_attr($options['h2_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h2_lineheight]" type="text" value="<?php if ($options['h2_lineheight']) { echo esc_attr($options['h2_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h2_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[h2_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h3_color]" type="text" value="<?php if ($options['h3_color']) { echo esc_attr($options['h3_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h3_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[h3_fontsize]" type="text" value="<?php if ($options['h3_fontsize']) { echo esc_attr($options['h3_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h3_lineheight]" type="text" value="<?php if ($options['h3_lineheight']) { echo esc_attr($options['h3_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h3_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[h3_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h4_color]" type="text" value="<?php if ($options['h4_color']) { echo esc_attr($options['h4_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h4_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[h4_fontsize]" type="text" value="<?php if ($options['h4_fontsize']) { echo esc_attr($options['h4_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h4_lineheight]" type="text" value="<?php if ($options['h4_lineheight']) { echo esc_attr($options['h4_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h4_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[h4_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h5_color]" type="text" value="<?php if ($options['h5_color']) { echo esc_attr($options['h5_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h5_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[h5_fontsize]" type="text" value="<?php if ($options['h5_fontsize']) { echo esc_attr($options['h5_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h5_lineheight]" type="text" value="<?php if ($options['h5_lineheight']) { echo esc_attr($options['h5_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h5_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[h5_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[h6_color]" type="text" value="<?php if ($options['h6_color']) { echo esc_attr($options['h6_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[h6_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[h6_fontsize]" type="text" value="<?php if ($options['h6_fontsize']) { echo esc_attr($options['h6_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[h6_lineheight]" type="text" value="<?php if ($options['h6_lineheight']) { echo esc_attr($options['h6_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[h6_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[h6_fontweight]">
						...
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[text_color]" type="text" value="<?php if ($options['text_color']) { echo esc_attr($options['text_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font family', 'qode'); ?>
										<select name="qode_options_lounge[text_google_fonts]">
											<option value="-1">Default</option>
											<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[text_fontsize]" type="text" value="<?php if ($options['text_fontsize']) { echo esc_attr($options['text_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[text_lineheight]" type="text" value="<?php if ($options['text_lineheight']) { echo esc_attr($options['text_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[text_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[text_fontweight]">
									...
									<div class="inline">
										...
										<input name="qode_options_lounge[text_margin]" type="text" value="<?php if (isset($options['text_margin'])) { echo esc_attr($options['text_margin'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
								</td>
						</tr>
						<tr valign="middle">
								...
								<td>
									<div class="inline">
										...
										<input name="qode_options_lounge[link_color]" type="text" value="<?php if ($options['link_color']) { echo esc_attr($options['link_color'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										...
										<input name="qode_options_lounge[link_hovercolor]" type="text" value="<?php if ($options['link_hovercolor']) { echo esc_attr($options['link_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[link_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[link_fontweight]">
									...
									<div class="inline">
										...
										<select name="qode_options_lounge[link_fontdecoration]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_lounge[page_title_position]">
								...
								<div class="inline">
									...
									<input name="qode_options_lounge[page_title_color]" type="text" value="<?php if ($options['page_title_color']) { echo esc_attr($options['page_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[page_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[page_title_fontsize]" type="text" value="<?php if ($options['page_title_fontsize']) { echo esc_attr($options['page_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[page_title_lineheight]" type="text" value="<?php if ($options['page_title_lineheight']) { echo esc_attr($options['page_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[page_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[page_title_fontweight]">
			...
			<div>
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('Header fixed', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[header_fixed]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_lounge[header_widget_area]">
						...
						<tr>
							<td scope="row" width="150"><?php esc_html_e('Header widget colors', 'qode'); ?></td>
							<td>
								<div class="inline">
									<?php esc_html_e('Color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['header_widget_color']){ echo 'background-color:'.esc_attr($options['header_widget_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_lounge[header_widget_color]" type="text" value="<?php if ($options['header_widget_color']) { echo esc_attr($options['header_widget_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['header_widget_background_color']){ echo 'background-color:'.esc_attr($options['header_widget_background_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_lounge[header_widget_background_color]" type="text" value="<?php if ($options['header_widget_background_color']) { echo esc_attr($options['header_widget_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline" style="width: 600px;">
									...
									<input type="text" id="logo_image" name="qode_options_lounge[logo_image]" class="logo_image" value="<?php if ($options['logo_image']) { echo esc_attr($options['logo_image'], 'qode'); } else { echo QODE_ROOT."/img/lounge-logo.png"; } ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
								<br/><br/>
								<div class="inline">
									<?php esc_html_e('Top (px)', 'qode'); ?>
									<input name="qode_options_lounge[logo_top]" type="text" value="<?php if ($options['logo_top']) { echo esc_attr($options['logo_top'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Left (px)', 'qode'); ?>
									<input name="qode_options_lounge[logo_left]" type="text" value="<?php if ($options['logo_left']) { echo esc_attr($options['logo_left'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[center_logo_image]">
						...
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('Fixed menu resize', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[menu_resize]">
									<option <?php if(isset($options['menu_resize'])){ $menu_resize = $options['menu_resize']; if ($menu_resize == 'yes') { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									<option <?php if(isset($options['menu_resize'])){ $menu_resize = $options['menu_resize']; if ($menu_resize == 'no') { echo "selected='selected'"; } } ?> value="no">No</option>
								</select>
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('First level menu type', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[first_level_type]">
									<option <?php if(isset($options['first_level_type'])){ $first_level_type = $options['first_level_type']; if ($first_level_type == 'italic') { echo "selected='selected'"; } } ?> value="italic">Italic</option>
									<option <?php if(isset($options['first_level_type'])){ $first_level_type = $options['first_level_type']; if ($first_level_type == 'normal') { echo "selected='selected'"; } } ?> value="normal">Normal</option>
								</select>
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('First level menu separators', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[first_level_separators]">
									<option <?php if(isset($options['first_level_separators'])){ $first_level_separators = $options['first_level_separators']; if ($first_level_separators == 'yes') { echo "selected='selected'"; } } ?> value="yes">Yes</option>
									<option <?php if(isset($options['first_level_separators'])){ $first_level_separators = $options['first_level_separators']; if ($first_level_separators == 'no') { echo "selected='selected'"; } } ?> value="no">No</option>
								</select>
							</td>
						</tr>
						<tr valign="middle">
							<td scope="row" width="150"><?php esc_html_e('First level menu separator type', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[first_level_separator_type]">
									<option <?php if(isset($options['first_level_separator_type'])){ $first_level_separator_type = $options['first_level_separator_type']; if ($first_level_separator_type == 'regular') { echo "selected='selected'"; } } ?> value="regular">Regular</option>
									<option <?php if(isset($options['first_level_separator_type'])){ $first_level_separator_type = $options['first_level_separator_type']; if ($first_level_separator_type == 'elegant') { echo "selected='selected'"; } } ?> value="elegant">Elegant</option>
								</select>
							</td>
						</tr>
						<tr valign="top">
								...
								<td>
									<div class="inline">
										<select name="qode_options_lounge[top_menu]">
											<option <?php if ($options['top_menu'] == "drop_down2") { echo "selected='selected'"; } ?> value="drop_down2">Dropdown Default</option>
											<option <?php if ($options['top_menu'] == "move_down") { echo "selected='selected'"; } ?> value="move_down">Dropdown Wide</option>
											<option <?php if ($options['top_menu'] == "drop_down1") { echo "selected='selected'"; } ?> value="drop_down1">Dropdown Elegant</option>
										</select>
									</div>
								</td>
						</tr>
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[menu_color]" type="text" value="<?php if ($options['menu_color']) { echo esc_attr($options['menu_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_lounge[menu_hovercolor]" type="text" value="<?php if (isset($options['menu_hovercolor'])) { echo esc_attr($options['menu_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[menu_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[menu_fontsize]" type="text" value="<?php if ($options['menu_fontsize']) { echo esc_attr($options['menu_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[menu_lineheight]" type="text" value="<?php if ($options['menu_lineheight']) { echo esc_attr($options['menu_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[menu_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[menu_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[dropdown_color]" type="text" value="<?php if (isset($options['dropdown_color'])) { echo esc_attr($options['dropdown_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_lounge[dropdown_hovercolor]" type="text" value="<?php if (isset($options['dropdown_hovercolor'])) { echo esc_attr($options['dropdown_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[dropdown_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[dropdown_fontsize]" type="text" value="<?php if ($options['dropdown_fontsize']) { echo esc_attr($options['dropdown_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[dropdown_lineheight]" type="text" value="<?php if ($options['dropdown_lineheight']) { echo esc_attr($options['dropdown_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[dropdown_fontstyle]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[dropdown_fontweight]">
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[dropdown_color_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_color_thirdlvl'])) { echo esc_attr($options['dropdown_color_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_lounge[dropdown_hovercolor_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_hovercolor_thirdlvl'])) { echo esc_attr($options['dropdown_hovercolor_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[dropdown_google_fonts_thirdlvl]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
									...
									<div class="inline">
										<?php esc_html_e('Font size (px)', 'qode'); ?>
										<input name="qode_options_lounge[dropdown_fontsize_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_fontsize_thirdlvl'])) { echo esc_attr($options['dropdown_fontsize_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Line height (px)', 'qode'); ?>
										<input name="qode_options_lounge[dropdown_lineheight_thirdlvl]" type="text" value="<?php if (isset($options['dropdown_lineheight_thirdlvl'])) { echo esc_attr($options['dropdown_lineheight_thirdlvl'], 'qode'); } ?>" size="10" maxlength="10" />
									</div>
									<div class="inline">
										<?php esc_html_e('Font style', 'qode'); ?>
										<select name="qode_options_lounge[dropdown_fontstyle_thirdlvl]">
									...
									<div class="inline">
										<?php esc_html_e('Font weight', 'qode'); ?>
										<select name="qode_options_lounge[dropdown_fontweight_thirdlvl]">
						...
						<tr>
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[footer_separator_color]" type="text" value="<?php if (isset($options['footer_separator_color'])) { echo esc_attr($options['footer_separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Thickness (px)', 'qode'); ?>
									<input name="qode_options_lounge[footer_separator_thickness]" type="text" value="<?php if ($options['footer_separator_thickness']) { echo esc_attr($options['footer_separator_thickness'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="inline">
									<select name="qode_options_lounge[footer_widget_area]">
						...
						<tr>
							<td scope="row" width="150"><?php esc_html_e('Footer widget colors', 'qode'); ?></td>
							<td>
								<div class="inline">
									<?php esc_html_e('Color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['footer_widget_color']){ echo 'background-color:'.esc_attr($options['footer_widget_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_lounge[footer_widget_color]" type="text" value="<?php if ($options['footer_widget_color']) { echo esc_attr($options['footer_widget_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Background color', 'qode'); ?>
									<div class="colorSelector"><div style="<?php if ($options['footer_widget_background_color']){ echo 'background-color:'.esc_attr($options['footer_widget_background_color'], 'qode').';'; } ?>"></div></div>
									<input name="qode_options_lounge[footer_widget_background_color]" type="text" value="<?php if ($options['footer_widget_background_color']) { echo esc_attr($options['footer_widget_background_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
					</tbody>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<select name="qode_options_lounge[slider_transition_auto]">
								...
								<div class="inline">
									...
									<select name="qode_options_lounge[slider_transition_effect]">
								...
								<div class="inline">
									...
									<input name="qode_options_lounge[slider_transition_speed]" type="text" value="<?php if ($options['slider_transition_speed']) { echo esc_attr($options['slider_transition_speed'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Transition timeout (milliseconds)', 'qode'); ?>
									<input name="qode_options_lounge[slider_transition_timeout]" type="text" value="<?php if ($options['slider_transition_timeout']) { echo esc_attr($options['slider_transition_timeout'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[slider_title_color]" type="text" value="<?php if ($options['slider_title_color']) { echo esc_attr($options['slider_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_title_fontsize]" type="text" value="<?php if ($options['slider_title_fontsize']) { echo esc_attr($options['slider_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_title_lineheight]" type="text" value="<?php if ($options['slider_title_lineheight']) { echo esc_attr($options['slider_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_fontweight]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[slider_text_color]" type="text" value="<?php if ($options['slider_text_color']) { echo esc_attr($options['slider_text_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[slider_text_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_text_fontsize]" type="text" value="<?php if ($options['slider_text_fontsize']) { echo esc_attr($options['slider_text_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_text_lineheight]" type="text" value="<?php if ($options['slider_text_lineheight']) { echo esc_attr($options['slider_text_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[slider_text_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[slider_text_fontweight]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[slider_title_color_type2]" type="text" value="<?php if ($options['slider_title_color_type2']) { echo esc_attr($options['slider_title_color_type2'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_google_fonts_type2]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_title_fontsize_type2]" type="text" value="<?php if ($options['slider_title_fontsize_type2']) { echo esc_attr($options['slider_title_fontsize_type2'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[slider_title_lineheight_type2]" type="text" value="<?php if ($options['slider_title_lineheight_type2']) { echo esc_attr($options['slider_title_lineheight_type2'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_fontstyle_type2]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[slider_title_fontweight_type2]">
			...
			<div>
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							<td valign="middle"><?php esc_html_e('Background picture', 'qode'); ?></td>
							<td>
								<div class="inline" style="width: 600px;">
									<input type="text" id="title_background_image" name="qode_options_lounge[title_background_image]" class="title_background_image" value="<?php echo esc_attr($options['title_background_image'], 'qode'); ?>" size="70">
									<input class="upload_button" type="button" value="Upload file">
								</div>
							</td>
						</tr>
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[separator_color]" type="text" value="<?php if (isset($options['separator_color'])) { echo esc_attr($options['separator_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Thickness (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_thickness]" type="text" value="<?php if ($options['separator_thickness']) { echo esc_attr($options['separator_thickness'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Top margin (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_topmargin]" type="text" value="<?php if ($options['separator_topmargin']) { echo esc_attr($options['separator_topmargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Bottom margin (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_bottommargin]" type="text" value="<?php if ($options['separator_bottommargin']) { echo esc_attr($options['separator_bottommargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<?php esc_html_e('Thickness (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_small_thickness]" type="text" value="<?php if ($options['separator_small_thickness']) { echo esc_attr($options['separator_small_thickness'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Width (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_small_width]" type="text" value="<?php if ($options['separator_small_width']) { echo esc_attr($options['separator_small_width'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Top margin (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_small_topmargin]" type="text" value="<?php if ($options['separator_small_topmargin']) { echo esc_attr($options['separator_small_topmargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Bottom margin (px)', 'qode'); ?>
									<input name="qode_options_lounge[separator_small_bottommargin]" type="text" value="<?php if ($options['separator_small_bottommargin']) { echo esc_attr($options['separator_small_bottommargin'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[button_title_color]" type="text" value="<?php if ($options['button_title_color']) { echo esc_attr($options['button_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Hover color', 'qode'); ?>
									...
									<input name="qode_options_lounge[button_title_hovercolor]" type="text" value="<?php if ($options['button_title_hovercolor']) { echo esc_attr($options['button_title_hovercolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[button_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[button_title_fontsize]" type="text" value="<?php if ($options['button_title_fontsize']) { echo esc_attr($options['button_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[button_title_lineheight]" type="text" value="<?php if ($options['button_title_lineheight']) { echo esc_attr($options['button_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[button_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[button_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_lounge[button_backgroundcolor]" type="text" value="<?php if ($options['button_backgroundcolor']) { echo esc_attr($options['button_backgroundcolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									...
									<input name="qode_options_lounge[button_border_color]" type="text" value="<?php if ($options['button_border_color']) { echo esc_attr($options['button_border_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								<div class="inline">
									...
									<input name="qode_options_lounge[message_title_color]" type="text" value="<?php if ($options['message_title_color']) { echo esc_attr($options['message_title_color'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font family', 'qode'); ?>
									<select name="qode_options_lounge[message_title_google_fonts]">
										<option value="-1">Default</option>
										<?php foreach($fontArrays as $fontArray) { ?> 
								...
								<div class="inline">
									<?php esc_html_e('Font size (px)', 'qode'); ?>
									<input name="qode_options_lounge[message_title_fontsize]" type="text" value="<?php if ($options['message_title_fontsize']) { echo esc_attr($options['message_title_fontsize'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Line height (px)', 'qode'); ?>
									<input name="qode_options_lounge[message_title_lineheight]" type="text" value="<?php if ($options['message_title_lineheight']) { echo esc_attr($options['message_title_lineheight'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
								<div class="inline">
									<?php esc_html_e('Font style', 'qode'); ?>
									<select name="qode_options_lounge[message_title_fontstyle]">
								...
								<div class="inline">
									<?php esc_html_e('Font weight', 'qode'); ?>
									<select name="qode_options_lounge[message_title_fontweight]">
								...
								<div class="inline">
									...
									<input name="qode_options_lounge[message_backgroundcolor]" type="text" class="colorpicker-input" value="<?php if ($options['message_backgroundcolor']) { echo esc_attr($options['message_backgroundcolor'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr><td colspan='2'><h2>Testimonial</h2></td></tr>
						<tr valign="middle">
							<td valign="middle"><?php esc_html_e('Testimonial timeout transition (ms)', 'qode'); ?></td>
							<td>
								<div class="inline">
									<input name="qode_options_lounge[testimonial_transition_speed]" type="text" value="<?php if (isset($options['testimonial_transition_speed'])) { echo esc_attr($options['testimonial_transition_speed'], 'qode'); } ?>" size="15" maxlength="15" />
								</div>
							</td>
						</tr>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_lounge[parallax_speed]" type="text" value="<?php if ($options['parallax_speed']) { echo esc_attr($options['parallax_speed'], 'qode'); } ?>" size="10" maxlength="10" />
								</div>
							</td>
						</tr>
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<select name="qode_options_lounge[parallax_onoff]">
						...
						<tr valign="middle">
							...
							<td>
								<div class="inline">
									<input name="qode_options_lounge[parallax_minheight]" type="text" value="<?php if ($options['parallax_minheight']) { echo esc_attr($options['parallax_minheight'], 'qode'); } ?>" size="10" maxlength="10" />
				...
				<table class="form-table">
					<tbody>
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[portfolio_style]">
				...
				<table class="form-table">
					<tbody>
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[pagination]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[blog_style]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[category_blog_sidebar]">
						...
						<tr valign="middle">
							...
							<td>
								<select name="qode_options_lounge[blog_hide_comments]">
						...
						<tr valign="middle">
							...
							<td>
								<input name="qode_options_lounge[number_of_chars]" type="text" class="colorpicker-input" value="<?php if ($options['number_of_chars']) { echo esc_attr($options['number_of_chars'], 'qode'); } ?>" size="10" maxlength="10" />
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<input name="qode_options_lounge[receive_mail]" type="text" value="<?php if ($options['receive_mail']) { echo esc_attr($options['receive_mail'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Contact Form', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[enable_contact_form]">
						...
						<tr valign="top">
							...
							<td>
								<select name="qode_options_lounge[hide_contact_form_website]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_lounge[email_from]" type="text" value="<?php if ($options['email_from']) { echo esc_attr($options['email_from'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Email Subject', 'qode'); ?></td>
							<td>
								<input name="qode_options_lounge[email_subject]" type="text" value="<?php if ($options['email_subject']) { echo esc_attr($options['email_subject'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Use reCaptcha', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[use_recaptcha]">
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_lounge[recaptcha_public_key]" type="text" value="<?php if ($options['recaptcha_public_key']) { echo esc_attr($options['recaptcha_public_key'], 'qode'); } ?>"  />
						...
						<tr valign="top">
							...
							<td>
								<input name="qode_options_lounge[recaptcha_private_key]" type="text" value="<?php if ($options['recaptcha_private_key']) { echo esc_attr($options['recaptcha_private_key'], 'qode'); } ?>"  />
							</td>
						</tr>			
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Heading above contact form', 'qode'); ?></td>
							<td>
								<input name="qode_options_lounge[contact_heading_above]" type="text" value="<?php if ($options['contact_heading_above']) { echo esc_attr($options['contact_heading_above'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Enable Google Map', 'qode'); ?></td>
							<td>
								<select name="qode_options_lounge[enable_google_map]">
						...
						<tr valign="top">
							...
							<td>
								<textarea id="google_maps_iframe" name="qode_options_lounge[google_maps_iframe]" cols="60" rows="5"><?php if (isset($options['google_maps_iframe'])) { echo esc_attr($options['google_maps_iframe'], 'qode'); } ?></textarea>
							</td>
						</tr>
						<?php endif; ?>
					</tbody>
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							...
							<td>
								<input name="qode_options_lounge[404_title]" type="text" value="<?php if ($options['404_title']) { echo esc_attr($options['404_title'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Subtitle', 'qode'); ?></td>
							<td>
								<input name="qode_options_lounge[404_subtitle]" type="text" value="<?php if ($options['404_subtitle']) { echo esc_attr($options['404_subtitle'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Text', 'qode'); ?></td>
							<td>
								<input name="qode_options_lounge[404_text]" type="text" value="<?php if ($options['404_text']) { echo esc_attr($options['404_text'], 'qode'); } ?>"  />
							</td>
						</tr>
						<tr valign="top">
							<td scope="row" width="150"><?php esc_html_e('Back to home label', 'qode'); ?></td>
							<td>
								<input name="qode_options_lounge[404_backlabel]" type="text" value="<?php if ($options['404_backlabel']) { echo esc_attr($options['404_backlabel'], 'qode'); } ?>"  />
							</td>
						</tr>
					</tbody>
				</table>
