...
$use_captcha = $qode_options_lounge['use_recaptcha'];
if ($resp->is_valid || $use_captcha == "no") {
?>success<?php

$email_to = $qode_options_lounge['receive_mail'];
$email_from = $qode_options_lounge['email_from'];
$subject = $qode_options_lounge['email_subject'];
