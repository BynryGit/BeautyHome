...
function qode_styles() {
	...
	$fonts_array  = array(
						$qode_options_lounge['google_fonts'].':200,300,400',
						$qode_options_lounge['menu_google_fonts'].':200,300,400',
						$qode_options_lounge['dropdown_google_fonts'].':200,300,400',
						$qode_options_lounge['dropdown_google_fonts_thirdlvl'].':200,300,400',
						$qode_options_lounge['h1_google_fonts'].':200,300,400',
						$qode_options_lounge['h2_google_fonts'].':200,300,400',
						$qode_options_lounge['h3_google_fonts'].':200,300,400',
						$qode_options_lounge['h4_google_fonts'].':200,300,400',
						$qode_options_lounge['h5_google_fonts'].':200,300,400',
						$qode_options_lounge['h6_google_fonts'].':200,300,400',
						$qode_options_lounge['text_google_fonts'].':200,300,400',
						$qode_options_lounge['slider_title_google_fonts'].':200,300,400',
						$qode_options_lounge['slider_title_google_fonts_type2'].':200,300,400',
						$qode_options_lounge['slider_text_google_fonts'].':200,300,400',
						$qode_options_lounge['page_title_google_fonts'].':200,300,400',
						$qode_options_lounge['button_title_google_fonts'].':200,300,400',
						$qode_options_lounge['message_title_google_fonts'].':200,300,400'
						);
...
function qode_scripts() {
	...
	if (($qode_options_lounge['page_transitions'] != "0") && (empty($qode_animation) || ($qode_animation != "no")))
		$has_ajax = true;
...
function ajax_classes($classes) {
	...
	if(($qode_options_lounge['page_transitions'] === "0") && ($qode_animation == "no")) :
		$classes[] = '';
	elseif($qode_options_lounge['page_transitions'] === "1" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_updown';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_lounge['page_transitions'] === "2" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_lounge['page_transitions'] === "3" && (empty($qode_animation) || ($qode_animation != "no"))) :
		$classes[] = 'ajax_updown_fade';
		$classes[] = 'page_not_loaded';
	elseif($qode_options_lounge['page_transitions'] === "4" && (empty($qode_animation) || ($qode_animation != "no"))) :
...
function boxed_class($classes) {
	...
	if($qode_options_lounge['boxed'] == "yes") :
		$classes[] = 'boxed';
	else:
	$classes[] ="";
	endif;
...
function qode_excerpt_length( $length ) {
	global $qode_options_lounge;
	if($qode_options_lounge['number_of_chars']){
		 return $qode_options_lounge['number_of_chars'];
	} else {
		return 45;
	}
}
